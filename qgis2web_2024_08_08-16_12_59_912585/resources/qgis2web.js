...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Slippi Ranked South America Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (123 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'As of August 8th, 2024.<br />Sorted by country of origin, not of residence.<br /><br />Data extracted from https://caioicy.github.io/slsa/';
            }
